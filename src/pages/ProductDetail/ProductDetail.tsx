...
export default function ProductDetail() {
  ...
  const [activeImage, setActiveImages] = useState('')
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='item-center flex'>
                  <span className='mt-1 border-b border-b-orange text-orange'>{product.rating}</span>
                  <ProducRating
              ...
              <div className='item-centers mt-8 flex'>
